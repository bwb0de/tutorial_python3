...
# e reúna-os em uma sequencia. Mostre na tela e valor do maior elemento,
# o valor do menor elemento e a mediana da sequência.
#
...
print("Maior elemento:", max(sequencia))
print("Menor elemento:", min(sequencia))

idx_mediana = len(sequencia) // 2

print("Mediana:", sequencia[idx_mediana])
